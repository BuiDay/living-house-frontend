...
import Image_1 from '@/assets/images/dinh-thu-phu-an/1.jpg'
import Image_2 from '@/assets/images/dinh-thu-phu-an/2.jpg'
import Image_3 from '@/assets/images/dinh-thu-phu-an/3.jpg'
import Image_4 from '@/assets/images/dinh-thu-phu-an/4.jpg'
                    ...
                    <div className='project-hero-inner'>
                        <div>
                            ...
                            <div className='max-width-medium py-5'>
                                <h1 className="text-[60px] mt-10 font-medium">Dinh Thự Phú An</h1>
                            </div>
                        </div>
                        <div>
                            <div className='margin-bottom margin-medium'>
                                <div className='max-width-medium'>
                                Thiết kế phối cảnh 3D Dinh Thự Phú An
                                </div>
                            </div>
                        </div>
                    </div>
