...
import Image_1 from '@/assets/images/san-khau-kich-hong-van/1.jpg'
import Image_2 from '@/assets/images/san-khau-kich-hong-van/2.jpg'
import Image_3 from '@/assets/images/san-khau-kich-hong-van/3.jpg'
import Image_4 from '@/assets/images/san-khau-kich-hong-van/4.jpg'
import Image_5 from '@/assets/images/san-khau-kich-hong-van/5.jpg'
import Image_6 from '@/assets/images/san-khau-kich-hong-van/6.jpg'
import Image_7 from '@/assets/images/san-khau-kich-hong-van/7.jpg'
                    ...
                    <div className='project-hero-inner'>
                        <div>
                            ...
                            <div className='max-width-medium py-5'>
                                <h1 className="text-[60px] mt-10 font-medium">Sân Khấu Kịch Hồng Vân</h1>
                            </div>
                        </div>
                        <div>
                            <div className='margin-bottom margin-medium'>
                                <div className='max-width-medium'>
                                    Thiết kế và thi công trọn gói Sân Khấu Kịch NSND Hồng Vân
                                </div>
                            </div>
                        </div>
                    </div>
