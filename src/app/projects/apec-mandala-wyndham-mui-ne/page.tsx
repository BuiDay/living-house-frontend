...
import Image_1 from '@/assets/images/condotel/1.jpg'
import Image_2 from '@/assets/images/condotel/2.jpg'
import Image_3 from '@/assets/images/condotel/3.jpg'
import Image_4 from '@/assets/images/condotel/4.jpg'
import Image_5 from '@/assets/images/condotel/5.jpg'
import Image_6 from '@/assets/images/condotel/6.jpg'
import Image_7 from '@/assets/images/condotel/7.jpg'
import Image_8 from '@/assets/images/condotel/8.jpg'
    ...
    return (
        <main className="main">
            <div className="horizontal-sliders">
                    ...
                    <div className='project-hero-inner'>
                        <div>
                            ...
                            <div className='max-width-medium py-5'>
                                <h1 className="text-[45px] mt-10 font-medium">Condotel Apec Mandala Wyndham <br/> Mũi Né</h1>
                            </div>
                        </div>
                        <div>
                            <div className='margin-bottom margin-medium'>
                                <div className='max-width-medium'>
                                    Thiết kế và thi công nội thất căn hộ Condotel Apec Mandala Wyndham Mũi Né
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='project-about-image-wrapper'>
                        <div className='project-about-card'>
                            <div>
                                ...
                                <div className="text-size-small">TP Phan Thiết,Bình Thuận</div>
                            </div>
                ...
                <section className="slide section-project-about">
                    <div className='project-about-image-wrapper'>
                        <Image src={Image_7} alt='' className='image-cover'></Image>
                    </div>
                </section>
                <section className="slide section-project-about">
                    <div className='project-about-image-wrapper'>
                        <Image src={Image_8} alt='' className='image-cover'></Image>
                    </div>
                </section>
                <section className="slide section-project-about">          
                    <div className='project-about-image-wrapper'>
