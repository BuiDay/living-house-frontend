...
import Image_1 from '@/assets/images/the-678-building/1.jpg'
import Image_2 from '@/assets/images/the-678-building/2.jpg'
    ...
    return (
        <main className="main">
            <div className="horizontal-sliders">
                    ...
                    <div className='project-hero-inner'>
                        <div>
                            ...
                            <div className='max-width-medium py-5'>
                                <h1 className="text-[60px] mt-10 font-medium">The 678 Building</h1>
                            </div>
                        </div>
                        <div>
                            <div className='margin-bottom margin-medium'>
                                <div className='max-width-medium'>
                                    Thiết kế và thi công nội thất tòa nhà văn phòng hạng A The 678 Building.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="slide section-project-about">
                    <div className='project-about-image-wrapper'>
                        <Image src={Image_2} alt='' className='image-cover !object-contain'></Image>
                    </div>
                </section>
